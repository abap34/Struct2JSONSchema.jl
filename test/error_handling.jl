...
@testset "multiple unsupported fields" begin
    ...
    @test any(e -> e.type == Function && e.path == (:func1,) && e.reason == "abstract_no_discriminator", result.unknowns)
    @test any(e -> e.type == Function && e.path == (:func2,) && e.reason == "abstract_no_discriminator", result.unknowns)
end
